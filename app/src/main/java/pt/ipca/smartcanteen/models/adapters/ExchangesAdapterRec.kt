...
class ExchangesAdapterRec(val progressBar: ProgressBar, val textProgress: TextView, val linearLayoutManager: LinearLayoutManager, val sp: SharedPreferences, val myTradesAdapter: RecyclerView, private var exchangesList: List<RetroTrade>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExchangesAdapterRecViewHolder {
        ...
        return ExchangesAdapterRecViewHolder(progressBar, textProgress, linearLayoutManager, sp, myTradesAdapter, inflater,parent)
    }
